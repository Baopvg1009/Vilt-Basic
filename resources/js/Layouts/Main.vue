        ...
        >
            ...
            <div class="flex items-center space-x-6">
                ...
                <div v-if="user" class="relative">
                    <div
                        @click="show = !show"
                        class="class flex items-center gap-2 px-3 py-1 rounded-lg hover:bg-slate-700 cursor-pointer"
                    >
                        <p>{{ user.name }}</p>
                    ...
                    <div
                        v-show="show"
                        @click="show = false"
                        class="absolute z-50 top-16 right-0 bg-slate-800 text-white rounded-lg border-x-slate-300 border overflow-bidden w-40"
                    >
                        <Link
                ...
                <Button
                    @click="switchTheme"
                    class="hover:bg-slate-700 w-6 h-6 grid place-items-center rounded-full hover:outline-1 outline-white"
                >
